...
@* Determines whether the unit is master or slave, and starts communication upon recognizing master.
...
@* Checks if data has been received normally, and if so, copies the received data to user receive buffer.
@
@* Called from MultiSioMain().
