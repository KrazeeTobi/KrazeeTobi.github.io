AGB Sample Game Explanation 
 ...
 - Operation Instructions
   ...
   jumps.  
   The dolphin moves up and down, and right and left with the +Control Pad.   
   If the dolphin bumps against a nautilus that is floating under water, the 
   dolphin knocks it over.  


 - Characters

   Dolphin
     A character controlled by the game player.
   Nautiluses
     They are objects floating under water. 
 ...
 - Program Description
   ...
   BG Planes
    ...
    Ocean B BG2     256 colros  screen size 256 x 256
