...
OFS_MS_SYNC_RECV_FRAME_COUNTER  *   12      ; Received frame counter
...
;* Checks whether or not data was received normally, and if so, 
;  copies the received data to user receive buffer.
;
;* Called from MultiSioMain().
;* It is not necessary to call directly.
;
