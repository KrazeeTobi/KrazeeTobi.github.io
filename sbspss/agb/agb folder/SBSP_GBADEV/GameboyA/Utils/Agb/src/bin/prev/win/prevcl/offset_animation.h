...
#ifndef	__OFFSET_ANIMATION_H__
#define	__OFFSET_ANIMATION_H__
...
//-----------------------------------------------------------------
class OffsetAnimationKey : public KeyObject
{
protected :
    f32 m_x;
    f32 m_y;
...
public :
    OffsetAnimationKey() : m_x(0),m_y(0){}

    virtual u32 GetSize(void);
} ;
//-----------------------------------------------------------------
class OffsetAnimation : public AGBAnimNode
{
protected :
...
public :
    OffsetAnimation( NodeMagic* node_magic_ptr ,
