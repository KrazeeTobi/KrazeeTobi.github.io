...
u16	map_x_size_tiles;  	// map x size in 8x8 tiles.
u16	map_y_size_tiles;	// map y size in 8x8 tiles.

u16	map_x_size_pixels;	// map x size in pixels.
u16	map_y_size_pixels;	// map y size in pixels.

s32	map_xpos;			// map x-axis co-ordinate.
s32	map_ypos;			// map y-axis co-ordinate.

u16	x_tilepos1;			// map x-axis tile position used for bg1.
u16	y_tilepos1;			// map y-axis tile position used for bg1.
u16	x_tilepos2;			// map x-axis tile position used for bg2.
u16	y_tilepos2;			// map y-axis tile position used for bg2.

u8 x_shift1;			// map x-axis fine shift store used for bg1.
u8 y_shift1;			// map y-axis fine shift store used for bg1.
u8 x_shift2;			// map x-axis fine shift store used for bg2.
u8 y_shift2;			// map y-axis fine shift store used for bg2.
