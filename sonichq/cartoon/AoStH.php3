...
<a name=1>#1. The Super Special Sonic Search And Smash Squad (Pilot Episode)</a>
</table></div>

<div class=itemtext>
The first episode of the season, this ep was HORRIBLY ANIMATED even worse so than its future counterparts. Doctor Robotnik has created three new badniks under the monicker of the "Super Special Sonic Search and Smash Squad" - codenamed Scratch,
Grounder, and Coconuts, thier full job is to eradicate the devilish Doc's number one enemy - Sonic The Hedgehog!<p>
</div><div class=titlebar><table class=glow>
<a name=2>#2. Subterranian Sonic</a>
</table></div>

<div class=itemtext>
Whilst escaping from Scratch and Grounder in a network of abandoned mine shafts, Sonic and Tails stumble across a hoard of diamonds, guarded by a miserly old mole. 
...
A weak plot attempting to justify itself by moralising.<p>
</div><div class=titlebar><table class=glow>
<a name=3>#3. Lovesick Sonic</a>
</table></div>

<div class=itemtext>
One of the more remembered AoSTH episodes among Sonic fans - Sonic saves a "Jessica Rabbit-like" hedgehog babe, Breezie, from Scratch and Grounder, and falls for her, not realising that she`s really a robot sent to exterminate him. 
...
became stark-raving stupid every time Breezie touched him didn't do much for the cartoon either...This was one of the few AoSTH toons (minus the Chaos Emerald Saga episodes) that could have had possible potential as a good episode, had it not tripped over itself so often.<p>
</div><div class=titlebar><table class=glow>
<a name=4>#4. Sloooowww Going...</a>
</table></div>

<div class=itemtext>
Doctor Robotnik's finally done it as he's invented a ray gun that's supposed to slow Sonic down for good! Sending the Dumbbots out to do his dirty work, a family of sloths comes under attack from Scratch and Grounder, who use them to lure Sonic into the path of the Doc's new Slow Motion Ray. 
...
In all honesty, this would have been a half-way descent episode if it weren't for the sluggard sloth characters at all....<p>
</div><div class=titlebar><table class=glow>
<a name=5>#5. High Stakes Sonic</a>
</table></div>

<div class=itemtext>
Doctor Robotnik's caught a bit of the ego bug as he needs workers to build a huge monument of -  himself! Question is how to lure the workers. Simple - he opens up his new Casino Night Zone to get gamblers to lose all they've got and have to work for him...<p>
</div><div class=titlebar><table class=glow>
<a name=6>#6. Sonic Breakout</a>
</table></div>

<div class=itemtext>
A popular satirical comic artist, Sketch Lampoon, is imprisoned, and it`s in the interest of Mobian morale for Sonic and Tails to break into the prison and get him out - before Robotnik uses his skills for propaganda among the Mobian people! 
Unfortunately, Lampoons jokes are so bad and his character so irritating, that he should be left in there...<p>
</div><div class=titlebar><table class=glow>
<a name=7>#7. Trail Of The Missing Tails</a>
</table></div>

<div class=itemtext>
Five years ago, Robotnik banished his insane cousin Warpnik to the "Zone of Confusion". Unfortunately, seeking revenge, Warpnik has escaped and in a three ring bind of sorts he captures Tails, knowing that Sonic will follow Tails, and knowing that Robotnik will follow Sonic! 
...
insane person's head, this is going to be difficult....<p>
</div><div class=titlebar><table class=glow>
<a name=8>#8. Close Encounters Of The Sonic Kind</a>
</table></div>

<div class=itemtext>
Scratch and Grounder have a super-suction plate that they intend to have Sonic run over and get caught, but the suction beam goes up into outer space and hits a passing spaceship! 
...
BTW, the alien's brother <u>really is</u> a baby -- he's 2 years old!<p>
</div><div class=titlebar><table class=glow>
<a name=9>#9. Mama Robotnik's Birthday</a>
</table></div>

<div class=itemtext>
It's Mama Robotnik's Birthday and she's broken out of the asylum 
...
sense to KEEP her locked up in that @#$% asylum...If Yuji Naka were to see it he would most likely break down into tears of sorrow...<p>
</div><div class=titlebar><table class=glow>
<a name=10>#10. Big Daddy</a>
</table></div>

<div class=itemtext>
A giant baby ape comes to Sonic for help, looking for its missing father! The parent has been kidnapped by Robotnik, who plans to destroy most of Mobius with both it and his new laser weapon, from the top of Mount Mobius! Cue the giant ape climbing up a tower - I honestly and truly think this entire episode was written SOLELY for that King Kong gag...<p>
</div><div class=titlebar><table class=glow>
<a name=11>#11. Sonic's Song (Note - "Sing It Again, Sonic!": Australia)</a>
</table></div>

<div class=itemtext>
A popular singer, Catty Carlisle, writes a song about Sonic, and it soars to the top of the charts. A furious Robotnik captures her, and Sonic rescues her. And that`s about it. Basically, 30 minutes of a damsel in distress that sounds like she has a dying weasel caught in her throat. Oh, and the song`s infuriating, too. <p>
</div><div class=titlebar><table class=glow>
<a name=12>#12. Birth Of A Salesman!</a>
</table></div>

<div class=itemtext>
He's heeeerrreee....Wes Weasely, the recurring super-salesman weasel has arrived in his premier episode. Weasely tries to sell weapons to Dr. 
...
<br>
<br>Beyond the usual animation, this was actually a pretty decent episode. Tails' gets first billing here and the bit of Robotnik wanting to freeze tails to death "for the good of the people" was honestly hilarious.<p>
</div><div class=titlebar><table class=glow>
<a name=16>#16. Tails' New Home</a>
</table></div>

<div class=itemtext>
In an episode that expands a bit on Tails' origins - Tails has been feeling lonely lately and after having so much adventure he comes the point to where he wants to join a family. 
...
<br>
<br>Yet another of one of the more tolerable AoSTH episodes, with Tails` history as a redeeming feature. While it did have its usual quota of overusing slapstick and bad annimation, the episode was actually quite tolerable.<br><br><p>
</div><div class=titlebar><table class=glow>
<a name=17>#17. Over The Hill Hero</a>
</table></div>

<div class=itemtext>
Sonic rescues old, out of shape, Captain Invincible, but at the end, it's the other way around...Sonic`s freedom fighting efforts are suddenly hampered by an incompetent veteran superhero with a lust for glory - 
...
But Tails convinces him to save the day. Breaking the double streak of decent episodes, this is another ep with the sentimentality laid on so thick you could cut it...<p>
</div><div class=titlebar><table class=glow>
<a name=18>#18. Blank Headed Eagle</a>
</table></div>

<div class=itemtext>
When a teenage girl eagle suffers a blow to the head, she believes that Scratch is her favourite T.V. hero, and aids him in fighting against Sonic! When she is finally brought back to normal, Sonic arranges for her to meet her real hero. Bland, rather than blank, should be the word.<p>
</div><div class=titlebar><table class=glow>
<a name=19>#19. Mystery Of The Missing Hi-Tops</a>
</table></div>
...
It was interesting seeing how Sonic could react to a situation where his speed is renedered moot. However its climax somehow ended up falling on its face.<p>
</div><div class=titlebar><table class=glow>
<a name=20>#20. So Long Sucker !!!</a>
</table></div>

<div class=itemtext>
When the robots rip open a door to an alternate dimension, a mysterious small purple alien blob creature from another dimension falls through into Tails hands and Sonic lets him keep it. Simple? WRONG! 
...
But things get really haywire when Robotnik angers the alien and it sucks up Sonic and Tails instead!!! The heroes eventually trick the robots into sending it home to its parents as things return back to abnormal.<p>
</div><div class=titlebar><table class=glow>
<a name=21>#21. Sonic Gets Trashed (Note - "Scrap Valley": U.K.)***</a>
</table></div>
...
<br>
<br>***Its unkown the exact title of this episode. In the U.K. it was known simply as "Scrap Valley", while the U.S. got the "trashed" title.<p>
</div><div class=titlebar><table class=glow>
<a name=22>#22. Psuedo-Sonic</a>
</table></div>

<div class=itemtext>
Way back in the earlier days of the Sonic comics - this was one of the episodes that MAY have been PARTIALLY adapted in the comics. (<i>Sonic The Hedgehog #9 to be exact</i>). 
...
The plot is... to be polite, formulaic, and the animation is even WORSE than usual.<p>
</div><div class=titlebar><table class=glow>
<a name=23>#23. Grounder The Genius</a>
</table></div>

<div class=itemtext>
This is debateably one of the <u>BEST EPISODES</u> of the season next to the four part <i>Quest</i> series. 
...
is only one thing that can defeat him - Scratch`s utter stupidity. Another of the all too few redeeming episodes for Tails fans, and almost patronising to computer users, as well! <p>
</div><div class=titlebar><table class=glow>
<a name=24>#24. Tails In Charge</a>
</table></div>

<div class=itemtext>
Doctor Robotnik invents a freeze-o-ray that he tries to use to petrify Sonic. 
...
Tails fans could be pleased as he takes yet another center stage role. That and the ending was honestly quite original.<p>
</div><div class=titlebar><table class=glow>
<a name=25>#25. Sno Problem</a>
</table></div>

<div class=itemtext>
Doctor Robotnik has invented The Ultra-Freezomatic with his goal to freeze every being on Mobius and place on them little cigarette-patch looking "Servitude Chips" 
...
fell quite lame on its ending.<p>
</div><div class=titlebar><table class=glow>
<a name=26>#26. Submerged Sonic</a>
</table></div>

<div class=itemtext>
This was one of the few stories to have a plot based on the game. Robotnik wants the Power Gems from the city of Submerbia in the Labyrinth Zone and he kidnapps the Princess Bubbles in order to do it! 
Little does he know of the love between Bubbles and her estranged merman boyfriend - who after being rebuked by the King goes to Sonic for help. The horrible surfer dude accent on the boyfriend did nothing to help an already weak plot.<p>
</div><div class=titlebar><table class=glow>
<a name=27>#27. Boogey Mania</a>
</table></div>

<div class=itemtext>
Robotnik makes a machine that turns dreams into reality and uses it on himself, creating a super "Nightmare monster" - and knowing Robotnik, that's <i>some</i> nightmare. Sonic makes his own monster to battle Robotnik's by feeding Tails lots and lots of junk food then using it on him. No comment....<p>
</div><div class=titlebar><table class=glow>
<a name=28>#28. Musta Been A Beautiful Baby!</a>
</table></div>

<div class=itemtext>
Robotnik somehow invents a ray that makes people turn into babies, and shoots 
...
but none work. This episode was just one deplorable stupid slapstick gag after another and was enough to turn any Sonic fan AWAY from this cartoon...<p>
</div><div class=titlebar><table class=glow>
<a name=29>#29. Robotnik Junior</a>
</table></div>

<div class=itemtext>
When Doctor Robotnik builds a robot "son" that looks like him he finally has a sense of pride. But the pride is soon dashed to pieces when the robot realizes 
he'd rather be on Sonic's side because "Sonic's nicer". The amount of lame in this episode is almost unbearable...<p>
</div><div class=titlebar><table class=glow>
<a name=30>#30. Full-Tilt Tails</a>
</table></div>

<div class=itemtext>
Another Tails concentrated episode thats actually almost decent - 
Tails unwittingly steps on a piece of "high-speed gum" that Dr. Robotnik invented and now he can run really SUPER fast! 
Theres just one drawback to his new super speed ability - because unfortunately, once he starts speeding, he can't control himself...<p>
</div><div class=titlebar><table class=glow>
<a name=31>#31. Mac-Hopper</a>
</table></div>

<div class=itemtext>
When Scratch And Grounder capture a Freedom Fighting Kangaroo named MacHopper (A Cheap Crocodile Dundee wannabee) 
...
And so his mind begins to switch programming from lost memory, to regular memory, to Robotnik created memory and the only true mind reviver being none other than chili. <p>
</div><div class=titlebar><table class=glow>
<a name=32>#32. Momma Robotnik Returns!</a>
</table></div>

<div class=itemtext>
Momma Robotnik once again escapes from the asylum (see `Momma Robotnik`s Birthday`), and returns to wreak revenge on Sonic, notifying the law that a homeless minor is roaming the streets, and offering to adopt him. The minor you ask - TAILS !!!! The courts forcibly place him under her care even without Sonic's pleas, and she imprisons him in her fortress, using Tails, locked in her torture chamber, to keep him there!! Viewers will wish she`d stayed in the asylum.<p>
</div><div class=titlebar><table class=glow>
<a name=33>#33. Space Sonic (Note - "Spaceman Sonic": U.K.)</a>
</table></div>

<div class=itemtext>
Sonic and Tails are blasted into space whilst trying to prevent Robotnik from launching a deadly rocket towards a space station! When they arrive, they find the space station inhabited by a very hungry - and cold afflicted - alien, who views them as the first fresh meat for some time, but they bargain with the alien that it can chase Robotnik for as long as it wants, if it will help them return to Mobius! The sneezing alien is the only joke, and it doesn`t work.<p>
</div><div class=titlebar><table class=glow>
<a name=34>#34. Mad Mike Da Bear Warrior</a>
</table></div>
...
<br>
<br>The plot and the jokes have been used before and are getting QUITE STALE by now (<u>SERIOUSLY</u> look at all of the tired "amnesia" plots...), and of ALL the characters used they had to bring back "Da Bears"! SHEESH !!!<p>
</div><div class=titlebar><table class=glow>
<a name=35>#35. The Last Resort</a>
</table></div>

<div class=itemtext>
When Robotnik announces his intention to give up villainy, Sonic is therefore forced into retirement, and the offer of an all expenses paid adventure holiday from a town`s grateful mayor seems like just a thing to relieve his and Tails` boredom. 
But -shock! horror! - the mayor was really a robot, and the entire island is populated by the duplicitous Robotnik`s troops, hellbent upon bringing about the heroes` demise. Perhaps mercifully, this is completely bland...<p>
</div><div class=titlebar><table class=glow>
<a name=36>#36. Robotnik's Rival</a>
</table></div>

<div class=itemtext>
A half man, half duck (yes, really - we are NOT kidding) named Quark suddenly appears with his robot servant in tow, and attempts to oust Robotnik from the villainy stakes. The two attempt to co-operate and defeat Sonic, but rivalry and sheer stupidity mean that they fail and the newcomer is sent back to from whence he came. A very weak plot with no redeeming animation quality, and the inclusion of an outside villain has its usual lack of success...Just reading this should make you weep in despair.<p>
</div><div class=titlebar><table class=glow>
<a name=37>#37. The Magic Hassle</a>
</table></div>

<div class=itemtext>
A decent episode somewhat marred by the return of Wes Weasley. 
...
with the ultimate aim of forcing it to produce currency in his own image.<p>
</div><div class=titlebar><table class=glow>
<a name=38>#38. Sonic The Matchmaker</a>
</table></div>

<div class=itemtext>
In a simple episode with a stupidly simple premise, Robotnik builds a mechanical wife and tries to catch Sonic with her help, but Sonic messes with it so it treats Robotnik like scum.<p>
</div><div class=titlebar><table class=glow>
<a name=39>#39. Tails Prevails!</a>
</table></div>

<div class=itemtext>
One of Tails` inventions catches the eye of the goofy Professor Dinglehopper, who asks the fox to leave Sonic and become his research assistant! 
...
his new anti-Sonic weapon! All is saved when Sonic accidentally shows up. The professor is as infuriating as ever adding his usual amount of lameness to what could have been a decent episode.<p>
</div><div class=titlebar><table class=glow>
<a name=40>#40. Zoobotnik</a>
</table></div>

<div class=itemtext>
In one of the most <u>surreally odd</u> episodes EVER PRODUCED in Sonicdom - An intergalactic bounty-hunter comes to Mobius looking for unusual 
...
<br>
<br>WHOA.....This episode just made a 50 on the strange meter....Words just cant describe how completely off kilter this ep was - EVEN for the quality of AoSTH it managed to top itself in complete asininity. You just have to see it for yourself - and seeing Sonic as a preacher and Tails playing the organ......Words just cannot describe...<p>
</div><div class=titlebar><table class=glow>
<a name=41>#41. Attack On The Pinball Fortress</a>
</table></div>

<div class=itemtext>
In the adaption of <i>Sonic Spinball</i> for the Sega Genesis, Sonic, Wes Weasley and Sergeant Doberman (laugh? I almost cried) attempt to breach the defences of Robotnik`s new fortress, and NONE OF THEM can stand the sight of each other. They succeed, minor characters are their usual non-entities, and that really is all there is to to it..<p>
</div><div class=titlebar><table class=glow>
<a name=42>#42. Mass Transit Trouble</a>
</table></div>

<div class=itemtext>
One of the better episodes of AoSTH, Robotnik plants bombs at three of Mobius` centres of transport: an airport, a port and a railway station, threatening to cause chaos unless Sonic can effectively be in three places at once!!!!! Cue a hedgehog ego trip...<p>
</div><div class=titlebar><table class=glow>
<a name=43>#43. The Coachnik</a>
</table></div>

<div class=itemtext>
Robotnik constructs a pushy P.T. robot in in attempt to increase Scratch and Grounder`s fitness, and the three of them try to rub out Sonic with various lethal sporting devices. That really is just about it as its another one of those annoying "slapstick full" episodes....mostly ending up in the slapstick NOT being funny....<p>
</div><div class=titlebar><table class=glow>
<a name=44>#44. Untouchable Sonic</a>
</table></div>

<div class=itemtext>
My, my, my..... DiC Animation <u>LOVES</u> recycled plots !!!! Sonic comes to the rescue of yet another town as it is held to ransom by a crime syndicate under the control of Doc Robotnik! Read `The Magnificent Sonic`, `Scrap Valley`, `Robolympics`, `High Stakes Sonic`, etc. etc....<p>
</div><div class=titlebar><table class=glow>
<a name=45>#45. Super Robotnik</a>
</table></div>

<div class=itemtext>
Coconuts knockes a bunch of chemical mixes off a shelf into a vat. Robotnik 
...
"Exactly!"
<br>
<br>Now there was just no excuse for this episode at all....I'd have been ashamed to have been associated with it. Not to mention all of the butt jokes got REALLY ANNOYING after you've heard them the first 20 million times...<p>
</div><div class=titlebar><table class=glow>
<a name=46>#46. Robolympics</a>
</table></div>

<div class=itemtext>
An asteroid is heading towards Turtle Town, and Robotnik agrees to save it if Sonic will participate in the Robolympics against himself, Scratch and Grounder! 
...
Another reasonable episode for Tails fans, owing to the ending, but that`s about it.<p>
</div><div class=titlebar><table class=glow>
<a name=47>#47. The Magnificent Sonic</a>
</table></div>
...
Sonic's ancestor has to eternally attempt to get the emerald, so now TWO Sonics are after Doctor Robotnik! They defeat him, and Sonic gives the emerald to his ancestor, who can finally rest in peace. Robotnik completely fuming, then goes back through time even further to his final trump card....<p>
</div><div class=titlebar><table class=glow>
<a name=51>#51. Quest For The Chaos Emeralds - Part Four: Prehistoric Sonic</a>
</table></div>

<div class=itemtext>
Next to <i>Grounder The Genius</i> and the previous <i>Robotnik's Pyramid Scheme</i> 
...
Sonic and Tails must use the rocket powered skateboard to go back in time to the Dinosaur Age and try to stop Robotnik once and for all and yet somehow Sonic prevails again...WRONG!!!! Doctor Robotnik has won! Or has he? Suddenly Sonic gets the idea that if he cant stop him by himself - then what he MULTIPLE Sonics could stop him? Sonic and Tails may not stop him in the past.....But in the present, they will...with a little help from multiple Sonics gathered one by one through the timestream... <p>
</div><div class=titlebar><table class=glow>
<a name=52>#52. Baby Sitter Jitters</a>
</table></div>

<div class=itemtext>
Sonic and Tails babysit a pair of baby beavers who`re at least as much trouble as Robotnik, and get themselves kidnapped at least as often as Tails!!! 
Robotnik attacks the heroes whilst they`re preoccupied, but the twins are ultimately better at seeing off villains than Sonic himself. Its depressing that after a four part good streak, AoSTH chooses to return to its "roots" with basically just another bad slapstick episode....<p>
</div><div class=titlebar><table class=glow>
<a name=53>#53. Honey, I Shrunk The Hedgehog</a>
</table></div>

<div class=itemtext>
Robotnik hatches a plan to shrink the sources of all of Mobius` natural resources, and keep them all in his fortress! 
Hit by his shrink ray, Sonic and Tails must make their way across the doctor`s lab and join forces with the residents of the shrunken cities to stop Robotnik!<p>
</div><div class=titlebar><table class=glow>
<a name=54>#54. Robotnik Land</a>
</table></div>

<div class=itemtext>
Sonic's birthday has arrived as he and all his friends end up in Robotnik Land. 
Doc Robotnik traps Sonic in a giant cake (that isn't even Sonic's favorite kind of frosting) 
and they end up escaping by using pipes to blow the top off and trap Robotnik in his own land of torture and hell.<p>
</div><div class=titlebar><table class=glow>
<a name=55>#55. The Mobius 5000</a>
</table></div>

<div class=itemtext>
When Robotnik threatens to close down an orphanage and evict all the poor little orphans, Sonic and Tails enter the goofy Professor Dinglehoppers car design in a race, 
in an attempt to win the prize money! But the robots, Scratch and Grounder are also competing, and dog Sonic and Tails all the way, <u>until</u> they realise that they may be replaced if Sonic is defeated....<p>
</div><div class=titlebar><table class=glow>
<a name=56>#56. The Little Merhog</a>
</table></div>

<div class=itemtext>
While fishing, when Tails pulls out a mermaid hedgehog named Merna, its up to Sonic and Tails to asave the day when they find out Doctor Robotnik is destroying her underwater city. This episode is unbearably stupid and the design of Merna is honestly quite ugly...<p>
</div><div class=titlebar><table class=glow>
<a name=57>#57. Road Hog</a>
</table></div>

<div class=itemtext>
Sonic gets a speeding ticket that he can't afford to pay, and has to do labor in a field to make up for it. 
Meanwhile, he learns of a plan that Robotnik is going to use a special pollen that hypnotizes people and makes them do his bidding! Problem is - how can he hope to stop Robotnik if he's trapped doing hard time?<p>
</div><div class=titlebar><table class=glow>
<a name=58>#58. The Robot's Robot</a>
</table></div>

<div class=itemtext>
Doctor Robotnik invents a machine that literally implodes everything, he's going to use it to conquer the planet once and for all once he installs the BLAMMO component... 
...
And its thus here that Sonic has to recover the BLAMMO from the robot before it implodes the whole planet!<p>
</div><div class=titlebar><table class=glow>
<a name=59>#59. Tails' Tale</a>
</table></div>

<div class=itemtext>
When Sonic dissapears from the face of the planet mysteriously it's up to Tails to locate him with the help of Professor Dinglehopper! 
...
episodes but marred by the appearance of the goofy acting Professor. <p>
</div><div class=titlebar><table class=glow>
<a name=60>#60. Hero Of The Year</a>
</table></div>

<div class=itemtext>
Doc Robotnik's up to his old tricks as he's convinced a superhero that Sonic is the enemy! (Sound familiar? Check "Over The Hill Hero") 
...
<br>
<br>And just when it looks as if this could be one of the canditates for best episodes of AoSTH, all goes downhill as the AoSTH suddenly has a "Full House" moment where the tricked villian sees the error of his ways - Then, the superhero suddenly realized that Robotnik had tricked him and his show wasn't on TV at all. He rescued Sonic from the ball (but wait, wouldn't he have to go close to it? Why didn't it leak water?) and Sonic saved his friends by bailing water out with his Hero of the Year trophy. And the fact that the plot is recycled isn't much better...<p>
</div><div class=titlebar><table class=glow>
<a name=61>#61. Fast And Easy</a>
</table></div>

<div class=itemtext>
Robotnik is after Easy Eddie, a pick pocket that took his Chaos Emerald ring that he was going to use to conquer mobius and he wants it back...<p>
</div><div class=titlebar><table class=glow>
<a name=62>#62. Lifestyles Of The Sick And Twisted</a>
</table></div>

<div class=itemtext>
A parody of the old "Lifestyles of the Rich and Famous", except about Robotnik and 
his daily routine of evil - with a twist: especially when Robotnik kidnaps Robin Leech's neice! And to top that - Robin isn't so much of a good egg himself...<p>
</div><div class=titlebar><table class=glow>
<a name=63>#63. Sonic Is Running</a>
</table></div>

<div class=itemtext>
Robotnik is running for mayor or president or something, and Sonic runs against him to ensure that Robotnik won't win. But, Robotnik uses mind 
...
The plot is EXACTLY alike, the conclusion being that the Koopa Kids voted for Bowser and Bowser only voted for himself. Shameful....Plagairism on a cartoon. Now thats just SAD.<p>
</div><div class=titlebar><table class=glow>
<a name=64>#64. Robo Ninjas</a>
</table></div>

<div class=itemtext>
Robotnik captures a master of martial arts (Miyagi by any other name), and steals his knowledge in order to turn Scratch and Grounder into better fighters. The master`s pupil comes to Sonic and Tails for help, and the trio then battle the robots for the sensei`s freedom. Even more badly animated that usual and the fact that it plays like a bad Ninja Turtles episode on crack cocaine isn't much better.<p>
</div><div class=titlebar><table class=glow>
<a name=65>#65. Sonically Ever After</a>
</table></div>

<div class=itemtext>
Robotnik invents a ray gun that literally transports Sonic, Tails, and Robotniks' gang into 
...
never read him fairy tales. No comment whatsoever....<p>
</div><div class=titlebar><table class=glow>
<a name=christmasblast><A NAME=66>#66. Sonic Christmas Blast</A></a>
</table></div>

<div class=itemtext>
The final episode of the season (THANK GOODNESS). How ironic that the LAST EPISODE is one of the better of the season. 
...
Eventually finding him Santa points out a Special Ring that Sonic is wearing (that Sally gave Sonic the year before). that will give Sonic Super Speed if he passes a few tests. Can he pass these and save Christmas?. <p>
</div><!end of sections>
